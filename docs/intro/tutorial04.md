...
## 使用通用视图：代码还是少点好
detail() 和 results() 视图都很简单 —— 并且，像上面提到的那样，存在冗余问题。用来显示一个投票列表的 index() 视图（也在 [教程第 3 部分](tutorial03.md) 中）和它们类似。
...
当你对你所写的表单和通用视图感到满意后，请阅读 [教程的第 5 部分](tutorial05.md) 来了解如何测试我们的投票应用。